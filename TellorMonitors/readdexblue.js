...
var oldTellor = '0x0Ba45A8b5d5575935B8158a88C631E9F9C95a2e5'
...
async function readreqids(masterAdd,net ) {
    ...
    try {
      ...
      let newTellor = new ethers.Contract(tellorMasterAddress, tellorMAbi, provider);
...
readreqids(oldTellor,newTellor, netw)
    .then(() => process.exit(0))
    .catch(error => {
        console.error(error);
        process.exit(1);
